...
export default function Beverage() {
  ...
  const orderUpdateHandler = (
    ...
    handleUpdateProduct(targetOrderNumber, { ...product, beverage: itemText });
    router.push("/f2");
  };

  const menuItems = [
    { src: "/beverage/coke.png", text: "코카콜라", id: "" },
    { src: "/beverage/sprite.png", text: "사이다(스프라이트)", id: "" },
    { src: "/beverage/coke.png", text: "제로-코카콜라", id: "" },
    { src: "/beverage/iceCoffee.png", text: "아이스 아메리카노", id: "" },
    { src: "/beverage/hotCoffee.png", text: "뜨거운 아메리카노", id: "" },
